...
if(practica2_CONFIG_INCLUDED)
  return()
endif()
set(practica2_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(practica2_SOURCE_PREFIX /media/victoria/Nuevo vol/Universidad de Alicante/4º Curso/1º Cuatrimestre/33732 - ROBOTS MÓVILES/Prácticas/Práctica 2/código/moviles_P2/catkin_ws/src/practica2)
  set(practica2_DEVEL_PREFIX /media/victoria/Nuevo vol/Universidad de Alicante/4º Curso/1º Cuatrimestre/33732 - ROBOTS MÓVILES/Prácticas/Práctica 2/código/moviles_P2/catkin_ws/devel)
  set(practica2_INSTALL_PREFIX "")
  set(practica2_PREFIX ${practica2_DEVEL_PREFIX})
else()
  set(practica2_SOURCE_PREFIX "")
  set(practica2_DEVEL_PREFIX "")
  set(practica2_INSTALL_PREFIX /media/victoria/Nuevo vol/Universidad de Alicante/4º Curso/1º Cuatrimestre/33732 - ROBOTS MÓVILES/Prácticas/Práctica 2/código/moviles_P2/catkin_ws/install)
  set(practica2_PREFIX ${practica2_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'practica2' is deprecated")
...
set(practica2_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(practica2_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'noetic <noetic@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${practica2_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'practica2' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'practica2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
    _list_append_unique(practica2_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND practica2_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND practica2_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT practica2_NUM_DUMMY_TARGETS)
      set(practica2_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::practica2::wrapped-linker-option${practica2_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR practica2_NUM_DUMMY_TARGETS "${practica2_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::practica2::wrapped-linker-option${practica2_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND practica2_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(practica2_LIBRARY_DIRS ${lib_path})
      list(APPEND practica2_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'practica2'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND practica2_LIBRARIES ${lib})
    endif()
  endif()
...
set(practica2_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${practica2_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 practica2_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${practica2_dep}_FOUND)
      find_package(${practica2_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${practica2_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(practica2_INCLUDE_DIRS ${${practica2_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(practica2_LIBRARIES ${practica2_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${practica2_dep}_LIBRARIES})
  _list_append_deduplicate(practica2_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(practica2_LIBRARIES ${practica2_LIBRARIES})

  _list_append_unique(practica2_LIBRARY_DIRS ${${practica2_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(practica2_EXPORTED_TARGETS ${${practica2_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${practica2_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
