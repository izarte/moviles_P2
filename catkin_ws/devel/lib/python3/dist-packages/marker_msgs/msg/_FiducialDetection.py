...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.camera_d))
      ...
      for val1 in self.fiducial:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.Struct(pattern).pack(*val1.ids_confidence))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.camera_d = s.unpack(str[start:end])
      start = end
      end += 72
      ...
      for i in range(0, length):
        ...
        val1.ids_confidence = s.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.object_points = []
