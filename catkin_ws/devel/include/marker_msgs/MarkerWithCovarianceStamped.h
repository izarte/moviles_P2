...
bool operator==(const ::marker_msgs::MarkerWithCovarianceStamped_<ContainerAllocator1> & lhs, const ::marker_msgs::MarkerWithCovarianceStamped_<ContainerAllocator2> & rhs)
{
