...
struct FiducialDetection_
{
  ...
  _header_type header;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _camera_d_type;
  ...
  _type_type type;
   ...
   typedef std::vector< ::marker_msgs::Fiducial_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::marker_msgs::Fiducial_<ContainerAllocator> >> _fiducial_type;
...
bool operator==(const ::marker_msgs::FiducialDetection_<ContainerAllocator1> & lhs, const ::marker_msgs::FiducialDetection_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.camera_d == rhs.camera_d &&
    lhs.camera_k == rhs.camera_k &&
    lhs.type == rhs.type &&
    lhs.fiducial == rhs.fiducial;
}
